...
public class SSLUtils {
    ...
    public static void setCertificates(OkHttpClient.Builder aBuilder)
    {
        ...
        if (sslContext != null)
        {
            aBuilder.sslSocketFactory(sslContext.getSocketFactory(),xtm);
        }

        aBuilder.hostnameVerifier(UnSafeHostnameVerifier);
